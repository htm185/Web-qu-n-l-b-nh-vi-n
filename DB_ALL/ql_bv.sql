...
CREATE TABLE `hoadon` (
  ...
  `TienXetNghiem` FLOAT NOT NULL,
  `MaBaoHiem` NVARCHAR(50) DEFAULT 'Không có',
  `TongTien` FLOAT NOT NULL,
  `PhuongThucThanhToan` NVARCHAR(50) DEFAULT NULL CHECK (`PhuongThucThanhToan` IN ('MoMo', 'Tiền mặt', 'Visa')),
